...
package com.jtechme.apphub.privileged.install;
...
import com.jtechme.apphub.installer.PrivilegedInstaller;
...
abstract class InstallExtension {
    ...
    protected List<String> getPostInstallCommands() {
        ...
        commands.add("am start -n com.jtechme.apphub/.privileged.install.InstallExtensionDialogActivity --ez "
