package com.jtechme.apphub.data;
...
public class AppProvider extends FDroidProvider {
     ...
     * {@link com.jtechme.apphub.data.QuerySelection#add(QuerySelection)} and
     * {@link com.jtechme.apphub.data.QuerySelection#add(String, String[])} methods
     * will only return the base class {@link com.jtechme.apphub.data.QuerySelection}
     * which is not aware of the installed app table.
     * However, the
     * {@link com.jtechme.apphub.data.AppProvider.AppQuerySelection#add(com.jtechme.apphub.data.AppProvider.AppQuerySelection)}
    ...
    /**
     * Made static so that the {@link com.jtechme.apphub.data.AppProvider.UpgradeHelper} can access
