...
package com.jtechme.apphub.installer;
...
import com.jtechme.apphub.privileged.IPrivilegedCallback;
import com.jtechme.apphub.privileged.IPrivilegedService;
import com.jtechme.apphub.privileged.views.AppDiff;
import com.jtechme.apphub.privileged.views.AppSecurityPermissions;
import com.jtechme.apphub.privileged.views.InstallConfirmActivity;
...
public class PrivilegedInstaller extends Installer {
    ...
    private static final String PRIVILEGED_EXTENSION_SERVICE_INTENT = "com.jtechme.apphub.privileged.IPrivilegedService";
    public static final String PRIVILEGED_EXTENSION_PACKAGE_NAME = "com.jtechme.apphub.privileged";
