...
import com.jtechme.apphub.Hasher;
...
import com.jtechme.apphub.data.SanitizedFile;
...
public final class LocalRepoManager {
    ...
    public static class IndexXmlBuilder {
        ...
        /**
         * Alias for {@link com.jtechme.apphub.localrepo.LocalRepoManager.IndexXmlBuilder#tag(String, String)}
