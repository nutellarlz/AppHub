...
public class ApkProviderHelperTest extends BaseApkProviderTest {
    ...
    public void testKnownApks() {
        ...
        Apk[] known = {
            new MockApk("com.jtechme.apphub", 1),
            new MockApk("com.jtechme.apphub", 3),
            new MockApk("com.jtechme.apphub", 5),
        ...
        Apk[] unknown = {
            new MockApk("com.jtechme.apphub", 7),
            new MockApk("com.jtechme.apphub", 9),
            new MockApk("com.jtechme.apphub", 11),
            new MockApk("com.jtechme.apphub", 13),
    ...
    public void testFindByApp() {
        ...
        List<Apk> fdroidApks = ApkProvider.Helper.findByPackageName(getMockContext(), "com.jtechme.apphub");
    ...
    public void testFind() {
        ...
        for (int i = 0; i < 10; i++)
            TestUtils.insertApk(this, "com.fdroid.apk." + i, i);
