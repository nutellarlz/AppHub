...
import com.jtechme.apphub.RepoUpdater.UpdateException;
...
import com.jtechme.apphub.data.TempApkProvider;
import com.jtechme.apphub.data.TempAppProvider;
...
public class MultiRepoUpdaterTest extends InstrumentationTestCase {
    ...
    public class TestContext extends RenamingDelegatingContext {
         ...
         * the real com.jtechme.apphub app, not the test com.jtechme.apphub.test app.
         */
        @Override
