...
public class AppProviderTest extends FDroidProviderTest<AppProvider> {
    ...
    public void testUris() {
        ...
        App app = new App();
        app.packageName = "com.jtechme.apphub";
        ...
        assertValidUri(AppProvider.getContentUri("com.jtechme.apphub"));
    }
    ...
    public void testInsert() {
        ...
        // Insert a new record...
        insertApp("com.jtechme.apphub", "F-Droid");
        cursor = queryAllApps();
        assertNotNull(cursor);
        ...
        cursor.close();
        assertEquals("com.jtechme.apphub", app.packageName);
